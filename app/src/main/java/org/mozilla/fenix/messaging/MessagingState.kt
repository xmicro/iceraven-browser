 ...
 * @property messageToShow Indicates the message that should be shown to users, if it is null means there is not message
 *   that is eligible to be shown to users.
 */
