...
/**
 * A no-op [ScrollableToolbar] [AbstractComposeView]. Implements the interface only so [EngineViewClippingBehavior]
 * tracks its translation as a clipping dependency.
 */
