...
interface CreditCardsManagementInteractor {
    ...
    /**
     * Navigates to the credit card editor to edit the selected credit card. Called when a user taps on a credit card
     * item.
     *
    ...
    /** Navigates to the credit card editor to add a new credit card. Called when a user taps on 'Add card' button. */
 ...
 *
 * @param controller An instance of [CreditCardsManagementController] which will be delegated for all user interactions.
 */
class DefaultCreditCardsManagementInteractor(private val controller: CreditCardsManagementController) :
