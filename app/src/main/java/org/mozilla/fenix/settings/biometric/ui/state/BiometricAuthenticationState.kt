...
sealed class BiometricAuthenticationState {
    ...
    /**
     * The state where the screen is ready to be locked, but the user has not yet initiated the authentication process.
     * This is typically used to show an unlock button.
     */
