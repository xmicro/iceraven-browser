...
/**
 * An interface of the different types of interaction candidates that are possible for a dragged item. A dragged item's
 * location is compared against several destinations based on distance. Here, closest point means any point in the range
 * (x1..x2, y1..y2) of the dragged item as compared with its destination candidates.
 */
sealed interface InteractionType {
    ...
    /**
     * The closest point represents an interaction where nothing should happen, like if a dragged item is hovered over
