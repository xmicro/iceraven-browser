...
/**
 * Class to store a TabTray item's selection state criteria. This item may be a tab or group of tabs.
 *
 * @property isSelected: Appears selected from a multi-select view. There can be many.
 * @property isFocused: This is the most recently accessed tab - there can only be one! A tab can be both selected and
 *   focused.
