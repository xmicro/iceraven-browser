...
/**
 * Fenix implementation of the [SitePermissionsLearnMoreUrlProvider] used to determine the url when a permission prompt
...
class FenixSitePermissionLearnMoreUrlProvider : SitePermissionsLearnMoreUrlProvider {
    ...
    override fun getUrl(permission: Permission): String? {
        return when (permission) {
            ...
            is Permission.ContentLocalDeviceAccess ->
                SupportUtils.getGenericSumoURLForTopic(topic = SumoTopic.LOCAL_NETWORK_AND_DEVICE_ACCESS)
    ...
    private companion object {
        const val STORAGE_ACCESS_MDN_URL = "https://developer.mozilla.org/en-US/docs/Web/API/Storage_Access_API"
    }
}
