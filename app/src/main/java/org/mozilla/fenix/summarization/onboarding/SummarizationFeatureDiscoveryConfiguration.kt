 ...
 *
 * Provides discovery-specific behavior like highlighting the menu item and clearing it upon interaction.
 */
interface SummarizationFeatureDiscoveryConfiguration {
     ...
     *
     * It is a [StateFlow] because, unlike the rest, we require instant changes in this to reflect in the UI
     */
