...
object LocaleUtils {
    ...
    /**
     * Returns a name for the locale that is appropriate for display to the user. The display name will be in the
     * language of the specified locale.
     *
     * For example, in an any language locale, the German language locale or "de" would be presented as "Deutsch".
     *
    ...
    /**
     * Returns a name for the locale that is appropriate for display to the user based on the user's specified language.
     *
     * For example, in an an English language locale, the German language locale or "de" would be presented as "German".
     *
    ...
    private val LOCALE_TO_DISPLAY_NATIVE_NAME_MAP: Map<String, String> =
        mapOf(
            "an" to "Aragonés",
            "anp" to "अंगिका",
            "ar" to "العربية",
    ...
    val LOCALE_TO_DISPLAY_ENGLISH_NAME_MAP: Map<String, String> =
        mapOf(
            "an" to "Aragonese",
            "ar" to "Arabic",
            "ast" to "Asturian",
