...
object Stories {
    ...
    fun String.markAsOpenedFromHomeScreen() =
        toUri()
            .buildUpon()
    ...
    fun String.markAsOpenedFromStoriesScreen() =
        toUri()
            .buildUpon()
            .appendQueryParameter(
                STORY_URL_QUERY_PARAMETER_NAME,
    ...
    fun String.syncInternallyOpenedStoryMarker(source: String?) =
        when (source?.isUrlOfInternallyOpenedStory()) {
            true ->
                toUri()
                    .buildUpon()
                    .appendQueryParameter(
    ...
    fun String.isUrlOfAHomeScreenStory() =
        try {
    ...
    fun String.isUrlOfAStoriesScreenStory() =
        try {
