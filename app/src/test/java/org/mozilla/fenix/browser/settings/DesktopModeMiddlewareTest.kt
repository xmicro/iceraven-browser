...
class DesktopModeMiddlewareTest {
    ...
    @Test
    fun `GIVEN desktop mode is enabled WHEN the Store is initialized THEN the middleware should set the correct value in the Store`() =
        runTest {
            val expected = true
            val middleware =
                createMiddleware(
    ...
    @Test
    fun `GIVEN desktop mode is disabled WHEN the Store is initialized THEN the middleware should set the correct value in the Store`() =
        runTest {
            val expected = false
            val middleware =
                createMiddleware(
    ...
    @Test
    fun `GIVEN desktop mode is enabled WHEN the user toggles desktop mode off THEN the preference is updated`() =
        runTest {
            val expected = false
            val middleware =
                createMiddleware(
    ...
    @Test
    fun `GIVEN desktop mode is disabled WHEN the user toggles desktop mode on THEN the preference is updated`() =
        runTest {
            val expected = true
            val middleware =
                createMiddleware(
    ...
    @Test
    fun `GIVEN the user has toggled on desktop mode WHEN the preference update fails THEN the preference is reverted`() =
        runTest {
            val expected = false
            val middleware =
                createMiddleware(
            ...
            val store =
                BrowserStore(
                    initialState = BrowserState(desktopMode = expected),
                    middleware = listOf(middleware),
                )
    ...
    @Test
    fun `GIVEN the user has toggled off desktop mode WHEN the preference update fails THEN the preference is reverted`() =
        runTest {
            val expected = true
            val middleware =
                createMiddleware(
    ...
    @Test
    fun `GIVEN desktop mode is disabled WHEN the user toggles desktop mode on THEN record settings always request desktop site telemetry`() =
        runTest {
            val middleware =
                createMiddleware(
                    scope = this,
