...
class ToolbarVerticalGesturesHandlerTest(private val scenario: Scenario) {
    ...
    @Before
    fun setup() {
        every { toolbarLayout.height } returns
            when (scenario.isNavbarShown && scenario.toolbarPosition == BOTTOM) {
        ...
        every { toolbarLayout.rootWindowInsets } returns
    ...
    fun test() {
        ...
        val expectedTabsTrayPage =
            if (scenario.browsingMode.isPrivate) {
                Page.PrivateTabs
            } else {
                Page.NormalTabs
            }

        val initialSwipeClaimed =
        ...
        scenario.shouldClaimInitialSwipe?.let {
            assertEquals(it, initialSwipeClaimed)
        }
    ...
    companion object {
        ...
        fun scenarios(): List<Scenario> =
            listOf(
                ...
                BottomToolbarSwipe.copy(
                    initialSwipe =
                        swipeDown(fromScreenTop = false, toolbarHeight = TOOLBAR_HEIGHT * 2, yOffset = -TOOLBAR_HEIGHT),
                    isNavbarShown = true,
                    shouldOpenTabsTray = false,
                ),
                BottomToolbarSwipe.copy(
                    initialSwipe =
                        swipeUp(fromScreenTop = false, toolbarHeight = TOOLBAR_HEIGHT * 2, yOffset = -TOOLBAR_HEIGHT),
                    isNavbarShown = true,
                    shouldOpenTabsTray = true,
                ),
                BottomToolbarSwipe.copy(
                ...
                BottomToolbarSwipe.copy(
                    initialSwipe =
                        swipeLeft(fromScreenTop = false, toolbarHeight = TOOLBAR_HEIGHT * 2, yOffset = -TOOLBAR_HEIGHT),
                    isNavbarShown = true,
                    shouldOpenTabsTray = false,
                ),
                BottomToolbarSwipe.copy(
                ...
                BottomToolbarSwipe.copy(
                    initialSwipe =
                        swipeDown(fromScreenTop = false, toolbarHeight = TOOLBAR_HEIGHT * 2, swipeDistance = 10),
                    isNavbarShown = true,
                    shouldOpenTabsTray = false,
                ),
                BottomToolbarSwipe.copy(
                    initialSwipe =
                        swipeUp(fromScreenTop = false, toolbarHeight = TOOLBAR_HEIGHT * 2, swipeDistance = 10),
                    isNavbarShown = true,
                    shouldOpenTabsTray = false,
                ),
                BottomToolbarSwipe.copy(
                ...
                BottomToolbarSwipe.copy(
                    initialSwipe =
                        swipeDown(fromScreenTop = false, toolbarHeight = TOOLBAR_HEIGHT * 2, swipeDistance = 10),
                    followupSwipe =
                        swipeDown(fromScreenTop = false, toolbarHeight = TOOLBAR_HEIGHT * 2, swipeDistance = 40),
                    isNavbarShown = true,
                    shouldOpenTabsTray = false,
                ),
                BottomToolbarSwipe.copy(
                    initialSwipe =
                        swipeUp(fromScreenTop = false, toolbarHeight = TOOLBAR_HEIGHT * 2, swipeDistance = 10),
                    followupSwipe =
                        swipeUp(fromScreenTop = false, toolbarHeight = TOOLBAR_HEIGHT * 2, swipeDistance = 40),
                    isNavbarShown = true,
                    shouldOpenTabsTray = true,
                ),
                BottomToolbarSwipe.copy(
                ...
                // ///////////////////////////////////////////////////////////////////////////////////////
                // Scenarios where a predominantly horizontal swipe over the toolbar must not be claimed //
                // by the handler so that horizontally scrollable content like the tab strip - which is  //
                // rendered inside the toolbar layout - can receive and handle it instead.               //
                // ///////////////////////////////////////////////////////////////////////////////////////
                // Horizontal swipe with a slight valid vertical component (down) on the top toolbar.
                TopToolbarSwipe.copy(
                    initialSwipe = swipeRight(fromScreenTop = true),
                    shouldOpenTabsTray = false,
                    shouldClaimInitialSwipe = false,
                ),
                // Horizontal swipe with a slight valid vertical component (up) on the bottom toolbar.
                BottomToolbarSwipe.copy(
                    initialSwipe = swipeLeft(fromScreenTop = false),
                    isNavbarShown = false,
                    shouldOpenTabsTray = false,
                ...
                // A predominantly vertical swipe that has not yet reached the threshold is still claimed
                // so the in-progress gesture keeps being tracked toward opening the tabs tray.
                TopToolbarSwipe.copy(
                    initialSwipe = swipeDown(fromScreenTop = true, swipeDistance = 10),
                    shouldOpenTabsTray = false,
                    shouldClaimInitialSwipe = true,
                ),
                BottomToolbarSwipe.copy(
                    initialSwipe = swipeUp(fromScreenTop = false, swipeDistance = 10),
                    isNavbarShown = false,
        ...
        private val BottomToolbarSwipe =
            Scenario(
        ...
        private fun swipeDown(
            ...
            return Swipe(
                start =
                    ...
                    PointF(start.x + 5, start.y + swipeDistance).apply {
                        offset(0f, yOffset.toFloat())
                    },
            )
        }
        ...
        private fun swipeLeft(
            ...
            return Swipe(
                start =
                    ...
                    PointF(start.x - 50, start.y - 5f).apply {
                        offset(0f, yOffset.toFloat())
                    },
            )
        }
    ...
    data class ToolbarVerticalGesturesHandlerTestScenario(
        ...
        val shouldClaimInitialSwipe: Boolean? = null,
    )
