...
class NimbusGeckoUtilsTest {
    ...
    fun `createPrefSetter with OriginalGeckoPref returns setter for various types`() {
        ...
        val stringResult = createPrefSetter(originalGeckoPref = stringPref, setType = BrowserPrefType.STRING)
        ...
        val boolResult = createPrefSetter(originalGeckoPref = boolPref, setType = BrowserPrefType.BOOL)
    ...
    fun `createPrefSetter with GeckoPrefState returns setter for various types`() {
        val stringPref =
            GeckoPrefState(
                ...
                enrollmentValue =
                    PrefEnrollmentData(
                        experimentSlug = "123",
                        prefValue = "some-value",
                        featureId = "123",
                        variable = "abc",
                    ),
                isUserSet = false,
            )
        val stringResult = createPrefSetter(geckoPrefState = stringPref, setType = BrowserPrefType.STRING)
        assertNotNull(stringResult)
        assertEquals("string.pref", stringResult.pref)
        assertEquals("some-value", stringResult.value)
        assertEquals(Branch.USER, stringResult.branch)
        ...
        val intPref =
            GeckoPrefState(
                GeckoPref(pref = "int.pref", branch = PrefBranch.USER),
                geckoValue = null,
                enrollmentValue =
                    PrefEnrollmentData(experimentSlug = "123", prefValue = "123", featureId = "123", variable = "abc"),
                isUserSet = false,
            )
        ...
        val boolPref =
            GeckoPrefState(
                ...
                geckoValue = null,
                enrollmentValue =
                    PrefEnrollmentData(experimentSlug = "123", prefValue = "true", featureId = "123", variable = "abc"),
                isUserSet = false,
            )
    ...
    fun `createPrefSetter with GeckoPrefState throws for unparsable int and bool prefs`() {
        ...
        val boolPref =
            GeckoPrefState(
                GeckoPref(pref = "bool.pref", branch = PrefBranch.USER),
                geckoValue = null,
                enrollmentValue =
                    PrefEnrollmentData(
                        experimentSlug = "123",
    ...
    fun `createPrefSetter with GeckoPrefState throws when enrollment value is null`() {
        val state =
            GeckoPrefState(
                GeckoPref(pref = "some.pref", branch = PrefBranch.USER),
                geckoValue = null,
