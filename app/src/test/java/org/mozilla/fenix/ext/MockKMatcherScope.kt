...
/**
 * Verify that two intents are the same for the purposes of intent resolution (filtering). Checks if their action, data,
 * type, identity, class, and categories are the same. Does not compare extras.
 */
