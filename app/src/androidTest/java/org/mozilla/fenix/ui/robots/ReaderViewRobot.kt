...
class ReaderViewRobot {
    ...
    fun verifyAppearanceFontGroup(visible: Boolean = false) {
        ...
        onView(withId(readerviewR.id.mozac_feature_readerview_font_group))
    ...
    fun verifyAppearanceFontSansSerif(visible: Boolean = false) {
        Log.i(
            TAG,
            "verifyAppearanceFontSansSerif: Trying to verify that the sans serif font button is visible: $visible",
        )
        onView(withId(readerviewR.id.mozac_feature_readerview_font_sans_serif))
            .check(matches(withEffectiveVisibility(visibleOrGone(visible))))
    ...
    fun verifyAppearanceFontSerif(visible: Boolean = false) {
        ...
        onView(withId(readerviewR.id.mozac_feature_readerview_font_serif))
            .check(matches(withEffectiveVisibility(visibleOrGone(visible))))
    ...
    fun verifyAppearanceFontDecrease(visible: Boolean = false) {
        ...
        onView(withId(readerviewR.id.mozac_feature_readerview_font_size_decrease))
            .check(matches(withEffectiveVisibility(visibleOrGone(visible))))
    ...
    fun verifyAppearanceFontIncrease(visible: Boolean = false) {
        ...
        onView(withId(readerviewR.id.mozac_feature_readerview_font_size_increase))
            .check(matches(withEffectiveVisibility(visibleOrGone(visible))))
    ...
    fun verifyAppearanceColorGroup(visible: Boolean = false) {
        ...
        onView(withId(readerviewR.id.mozac_feature_readerview_color_scheme_group))
            .check(matches(withEffectiveVisibility(visibleOrGone(visible))))
    ...
    fun verifyAppearanceColorSepia(visible: Boolean = false) {
        ...
        onView(withId(readerviewR.id.mozac_feature_readerview_color_sepia))
            .check(matches(withEffectiveVisibility(visibleOrGone(visible))))
    ...
    fun verifyAppearanceColorDark(visible: Boolean = false) {
        ...
        onView(withId(readerviewR.id.mozac_feature_readerview_color_dark))
            .check(matches(withEffectiveVisibility(visibleOrGone(visible))))
    ...
    fun verifyAppearanceColorLight(visible: Boolean = false) {
        ...
        onView(withId(readerviewR.id.mozac_feature_readerview_color_light))
            .check(matches(withEffectiveVisibility(visibleOrGone(visible))))
    ...
    class Transition {
        ...
        fun closeReaderViewControlMenu(
        ...
        fun toggleSansSerif(interact: ReaderViewRobot.() -> Unit): Transition {
            fun sansSerifButton() = onView(withId(readerviewR.id.mozac_feature_readerview_font_sans_serif))
        ...
        fun toggleSerif(interact: ReaderViewRobot.() -> Unit): Transition {
            fun serifButton() = onView(withId(readerviewR.id.mozac_feature_readerview_font_serif))
        ...
        fun toggleFontSizeDecrease(interact: ReaderViewRobot.() -> Unit): Transition {
            fun fontSizeDecrease() = onView(withId(readerviewR.id.mozac_feature_readerview_font_size_decrease))
        ...
        fun toggleFontSizeIncrease(interact: ReaderViewRobot.() -> Unit): Transition {
            fun fontSizeIncrease() = onView(withId(readerviewR.id.mozac_feature_readerview_font_size_increase))
        ...
        fun toggleColorSchemeChangeLight(interact: ReaderViewRobot.() -> Unit): Transition {
            fun toggleLightColorSchemeButton() = onView(withId(readerviewR.id.mozac_feature_readerview_color_light))
        ...
        fun toggleColorSchemeChangeDark(interact: ReaderViewRobot.() -> Unit): Transition {
            fun toggleDarkColorSchemeButton() = onView(withId(readerviewR.id.mozac_feature_readerview_color_dark))
        ...
        fun toggleColorSchemeChangeSepia(interact: ReaderViewRobot.() -> Unit): Transition {
            fun toggleSepiaColorSchemeButton() = onView(withId(readerviewR.id.mozac_feature_readerview_color_sepia))
