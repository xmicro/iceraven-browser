...
class SettingsSubMenuDeleteBrowsingDataRobot {
    ...
    fun verifyAllCheckBoxesAreChecked() {
        ...
        Log.i(
            TAG,
            "verifyAllCheckBoxesAreChecked: Trying to verify that the \"Cookies and site data\" check box is checked",
        )
        ...
        Log.i(
            TAG,
            "verifyAllCheckBoxesAreChecked: Trying to verify that the \"Cached images and files\" check box is checked",
        )
    ...
    fun verifyBrowsingHistoryDetails(status: Boolean) {
        Log.i(
            TAG,
            "verifyBrowsingHistoryDetails: Trying to verify that the \"Browsing history\" check box is checked: $status",
        )
    ...
    fun verifyCookiesCheckBox(status: Boolean) {
        Log.i(
            TAG,
            "verifyCookiesCheckBox: Trying to verify that the \"Cookies and site data\" check box is checked: $status",
        )
    ...
    fun verifyCachedFilesCheckBox(status: Boolean) {
        Log.i(
            TAG,
            "verifyCachedFilesCheckBox: Trying to verify that the \"Cached images and files\" check box is checked: $status",
        )
        cachedFilesCheckBox().assertIsChecked(status)
        Log.i(
            TAG,
            "verifyCachedFilesCheckBox: Verified that the \"Cached images and files\" check box is checked: $status",
        )
    }
    ...
    fun verifySitePermissionsCheckBox(status: Boolean) {
        Log.i(
            TAG,
            "verifySitePermissionsCheckBox: Trying to verify that the \"Site permissions\" check box is checked: $status",
        )
        sitePermissionsCheckBox().assertIsChecked(status)
        Log.i(
            TAG,
            "verifySitePermissionsCheckBox: Verified that the \"Site permissions\" check box is checked: $status",
        )
    }
    ...
    fun verifyOpenTabsDetails(tabNumber: String) {
        Log.i(
            TAG,
            "verifyOpenTabsDetails: Trying to verify that the \"Open tabs\" option summary containing $tabNumber open tabs is visible",
        )
        openTabsDescription(tabNumber).check(matches(withEffectiveVisibility(Visibility.VISIBLE)))
        Log.i(
            TAG,
            "verifyOpenTabsDetails: Verified that the \"Open tabs\" option summary containing $tabNumber open tabs is visible",
        )
    }
    ...
    fun verifyDeleteBrowsingDataDialog() {
        Log.i(
            TAG,
            "verifyDeleteBrowsingDataDialog: Trying to verify that the delete browsing data dialog message is visible",
        )
        ...
        Log.i(
            TAG,
            "verifyDeleteBrowsingDataDialog: Trying to verify that the delete browsing data dialog \"Cancel\" button is visible",
        )
        dialogCancelButton().check(matches(withEffectiveVisibility(Visibility.VISIBLE)))
        Log.i(
            TAG,
            "verifyDeleteBrowsingDataDialog: Verified that the delete browsing data dialog \"Cancel\" button is visible",
        )
        Log.i(
            TAG,
            "verifyDeleteBrowsingDataDialog: Trying to verify that the delete browsing data dialog \"Delete\" button is visible",
        )
        dialogDeleteButton().check(matches(withEffectiveVisibility(Visibility.VISIBLE)))
        Log.i(
            TAG,
            "verifyDeleteBrowsingDataDialog: Verified that the delete browsing data dialog \"Delete\" button is visible",
        )
    }
    ...
    fun selectOnlyOpenTabsCheckBox() {
        ...
        Log.i(
            TAG,
            "selectOnlyOpenTabsCheckBox: Trying to verify that the \"Browsing history\" check box is not checked",
        )
        ...
        Log.i(
            TAG,
            "selectOnlyOpenTabsCheckBox: Trying to verify that the \"Cookies and site data\" check box is not checked",
        )
        ...
        Log.i(
            TAG,
            "selectOnlyOpenTabsCheckBox: Trying to verify that the \"Cached images and files\" check box is not checked",
        )
        ...
        Log.i(
            TAG,
            "selectOnlyOpenTabsCheckBox: Trying to verify that the \"Site permissions\" check box is not checked",
        )
    ...
    fun selectOnlyBrowsingHistoryCheckBox() {
        ...
        Log.i(
            TAG,
            "selectOnlyBrowsingHistoryCheckBox: Trying to verify that the \"Open tabs\" check box is not checked",
        )
        ...
        Log.i(
            TAG,
            "selectOnlyBrowsingHistoryCheckBox: Trying to verify that the \"Cookies and site data\" check box is not checked",
        )
        cookiesAndSiteDataCheckBox().assertIsChecked(false)
        Log.i(
            TAG,
            "selectOnlyBrowsingHistoryCheckBox: Verified that the \"Cookies and site data\" check box is not checked",
        )

        clickCachedFilesCheckBox()
        Log.i(
            TAG,
            "selectOnlyBrowsingHistoryCheckBox: Trying to verify that the \"Cached images and files\" check box is not checked",
        )
        cachedFilesCheckBox().assertIsChecked(false)
        Log.i(
            TAG,
            "selectOnlyBrowsingHistoryCheckBox: Verified that the \"Cached images and files\" check box is not checked",
        )

        clickSitePermissionsCheckBox()
        Log.i(
            TAG,
            "selectOnlyBrowsingHistoryCheckBox: Trying to verify that the \"Site permissions\" check box is not checked",
        )
        sitePermissionsCheckBox().assertIsChecked(false)
        ...
        Log.i(
            TAG,
            "selectOnlyBrowsingHistoryCheckBox: Trying to verify that the \"Downloads\" check box is not checked",
        )
        downloadsCheckBox().assertIsChecked(false)
        ...
        Log.i(
            TAG,
            "selectOnlyBrowsingHistoryCheckBox: Trying to verify that the \"Browsing history\" check box is checked",
        )
        browsingHistoryCheckBox().assertIsChecked(true)
    ...
    fun selectOnlyCookiesCheckBox() {
        ...
        Log.i(
            TAG,
            "selectOnlyCookiesCheckBox: Trying to verify that the \"Cookies and site data\" check box is checked",
        )
        cookiesAndSiteDataCheckBox().assertIsChecked(true)
        ...
        Log.i(
            TAG,
            "selectOnlyCookiesCheckBox: Trying to verify that the \"Cached images and files\" check box is not checked",
        )
        cachedFilesCheckBox().assertIsChecked(false)
    ...
    fun selectOnlyCachedFilesCheckBox() {
        ...
        Log.i(
            TAG,
            "selectOnlyCachedFilesCheckBox: Trying to verify that the \"Browsing history\" check box is not checked",
        )
        browsingHistoryCheckBox().assertIsChecked(false)
        ...
        Log.i(
            TAG,
            "selectOnlyCachedFilesCheckBox: Trying to verify that the \"Cookies and site data\" check box is not checked",
        )
        cookiesAndSiteDataCheckBox().assertIsChecked(false)
        Log.i(
            TAG,
            "selectOnlyCachedFilesCheckBox: Verified that the \"Cookies and site data\" check box is not checked",
        )
        Log.i(
            TAG,
            "selectOnlyCachedFilesCheckBox: Trying to verify that the \"Cached images and files\" check box is checked",
        )
        cachedFilesCheckBox().assertIsChecked(true)
        ...
        Log.i(
            TAG,
            "selectOnlyCachedFilesCheckBox: Trying to verify that the \"Site permissions\" check box is not checked",
        )
        sitePermissionsCheckBox().assertIsChecked(false)
    ...
    fun confirmDeletionAndAssertSnackbar() {
        Log.i(
            TAG,
            "confirmDeletionAndAssertSnackbar: Trying to click the delete browsing data dialog \"Delete\" button",
        )
...
private fun browsingHistoryDescription(addresses: String) =
    mDevice.findObject(UiSelector().textContains("$addresses addresses"))

private fun browsingHistoryCheckBox() = onView(allOf(withId(R.id.checkbox), hasSibling(withText("Browsing history"))))
...
private fun sitePermissionsCheckBox() = onView(allOf(withId(R.id.checkbox), hasSibling(withText("Site permissions"))))

private fun downloadsCheckBox() = onView(allOf(withId(R.id.checkbox), hasSibling(withText("Downloads"))))

private fun dialogMessage() = onView(withText("$appName will delete the selected browsing data.")).inRoot(isDialog())
