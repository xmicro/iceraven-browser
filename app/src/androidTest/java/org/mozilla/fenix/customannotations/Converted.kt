...
/**
 * Marks a legacy UI test as converted to one or more replacement tests in the TAE efficiency framework. The legacy test
 * continues to run alongside the replacement for safety; once the replacement has been green on main for the configured
 * cadence, the legacy test becomes a deletion candidate.
 *
